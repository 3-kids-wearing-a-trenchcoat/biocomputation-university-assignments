...
def compare_to_true_results(phen:NDArray[FTYPE], print_info:bool=False) -> pd.DataFrame:
    """
    ...
    # print highest deviation
    # print("highest deviation: " + str(np.abs(diff).max()))
...
if __name__ == "__main__":
    ...
    # in dummy Individual
    # dummy = Individual(TRUE,False)
    # dummy.phenotype_with_unclassified = TRUE
    # dummy.phenotype = TRUE
    # print(dummy.calc_fitness_score())

    # run and display output phenotype
    experiment = set_parameters({"mut_prob": 0.05,
                                 "crossover_prob": 0.8,
                                 "mut_standard_deviation": 1.8,
                                 "pop_size": 200,
                                 "satisfactory": 1e-5,
                                 "stagnation_limit": 200,
                                 "stagnation_diff": 1e-6,
